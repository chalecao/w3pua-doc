...
1. This chapter built the `HelloAgents` framework and explained "why we need to build our own Agent framework." Please analyze:
   ...
   - Section 7.1.1 mentioned four main limitations of current mainstream frameworks. Combined with your actual experience using a framework in [Chapter 6 exercises](/book/part2/chapter6) or actual projects, explain how these problems affect development efficiency.
